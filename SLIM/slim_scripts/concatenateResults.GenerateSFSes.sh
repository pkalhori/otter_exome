...
rundate=20191113 # set of simulations you're interested in (if is across different rundates you can list popsModelsRundates explicitly)
...
popMods=CA_AK/2D.3Epoch.NoTranslocation
